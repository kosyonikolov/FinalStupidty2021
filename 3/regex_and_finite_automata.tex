...
\textit{\textbf{Д-во:}}\\
Шом $L$ e регулярен език $\implies$ $\approx_L$ има краен брой класове на еквивалентност. \\
...
\begin{enumerate}
    ...
    \item \textit{\textbf{Лема 4}} -  $\forall q, p \in K: q \equiv_{n+1} p \iff q \equiv_n p$ и $\forall a \in \Sigma$, $\delta(q, a) \equiv \delta(p, a)$. \\
