...
$ \Rightarrow \{a_1, a_2, \dots, a_k, a\} $ са линейно независими
...
$ \Rightarrow \{a_1, a_2, \dots, a_k, a\} $ са линейно независими. $\square$
...
\[ \theta = v - v = (\lambda_1 - \lambda_1') e_1 + (\lambda_2 - \lambda_2') e_2 + \dots + (\lambda_n - \lambda_n') e_n\]
